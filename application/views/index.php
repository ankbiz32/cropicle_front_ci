			...
			<div class="row justify-content-center">
				<div class="col-lg-6 col-md-6">
					<div class="clv_heading">
						...
						<h4 class="text-success"><strong>05</strong> hawkers found in "Budhapara".</h4>
					</div>
					<div class="">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/fresh-orange.jpeg" alt="image"></div>
                                            <h4>Orange</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/Onion.jpg" alt="image"></div>
                                            <h4>Onion</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/ladyfinger.png" alt="image"></div>
                                            <h4>Ladyfinger</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/Coriander.jpg" alt="image"></div>
                                            <h4>Coriander</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <span class="product_label">30% off</span>
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/Mushroom.jpg" alt="image"></div>
                                            <h4>Mushroom</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/watermelon.jpg" alt="image"></div>
                                            <h4>Watermelon</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/carrots.jpg" alt="image"></div>
                                            <h4>Carrots</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
                                ...
                                <li>
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            <!-- <span class="product_label">30% off</span> -->
                                            <div class="org_product_image"><img src="<?=base_url('assets/')?>images/chillies.jpg" alt="image"></div>
                                            <h4>Chillies</h4>
											<h3><span>
												<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;</span>25
												<small>/kg &nbsp;&nbsp;&nbsp;
