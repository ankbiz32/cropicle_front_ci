...
<div class="clv_main_wrapper index_v1">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="clv_left_header"> 
                        <div class="clv_logo">
                            <a href="index.html"><img src="images/logo.png" alt="Cropicle" /></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="address_block">
                                        ...
                                        <p>512,Beand square, California</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="address_block">
    ...
    <!--Breadcrumb-->
    <div class="breadcrumb_wrapper" style="background: url(images/about-banner.jpg) no-repeat center; background-size: cover;">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form_block">
                                <h6>first name</h6>
                                <input type="text" class="form_field" placeholder="John David" >
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form_block">
                                <h6>last name</h6>
                                <input type="text" class="form_field" placeholder="Parker" >
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form_block">
                                <h6>email</h6>
                                <input type="text" class="form_field" placeholder="John@example.com" >
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form_block">
                                <h6>contact no.</h6>
                                <input type="text" class="form_field" placeholder="+(81) 16002-123-123" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="save_btn"><a href="javascript:;" class="clv_btn">save</a></div>
                        </div>
                    </div>
                </div>
            </div>
